                    ...
                    <table class="table table-bordered">
                        ...
                        <tr v-for="(item,index) in cart" :key="index">
                            ...
                            <div class="input-group mb-3" style="max-width: 120px;">
                                ...
                                <input type="text" class="form-control text-center" :value="item.qty" @change="emitBus($event.target.value,item.qty,item);changeQuantity(item)" placeholder="" aria-label="Example text with button addon" aria-describedby="button-addon1">
