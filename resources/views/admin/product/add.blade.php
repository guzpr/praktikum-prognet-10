        ...
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body card-block"> 
                    <form action="/admin/product/add" method="POST" class="form-horizontal">
                        @csrf
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9">
                                <input type="text" id="text-input" placeholder="Product Price" class="form-control" name="weight  ">
                            </div>
                        </div>
                        <div class="row form-group">
                                <div class="col col-md-3">
                                ...
                                <div class="col-12 col-md-9">
                                    <input type="text" id="text-input" placeholder="Product Price" class="form-control" name="stock">
                                </div>
                            </div>
                        <div class="row form-group">
                            <div class="col col-md-3">
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col col-md-9">
                                @foreach($category as $cat)
                                    <input type="checkbox" id="category_id" name="category_id[]" value="{{ $cate->id }}" class="form-check-input">{{ $cate->category_name }}
                                    <br>
                                @endforeach
                            </div>
                        </div>
